...
\section*{Vector Processors}
{
    ...
    \subsection*{Optimisations}
    {
        ...
        %\textbf{Chaining}: don't need to wait for a multiply to finish operating on a vector before we start adding with it, we only need to wait for the first element to be finished. Reduces the cost of RAW dependencies.
